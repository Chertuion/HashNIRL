...
def init_args():
    ...
    parser.add_argument('--check_point', default='/data/home/wxl22/NIROOD/check_point',type=str, help='check point for datasets')
    ...
    parser.add_argument('--log_dir', default='/data/home/wxl22/NIROOD/logs', type=str, help='log directory')
